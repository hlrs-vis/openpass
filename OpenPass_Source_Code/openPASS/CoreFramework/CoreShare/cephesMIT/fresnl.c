...
if( x2 < 2.5625 )
    {
    t = x2 * x2;
    ss = x * x2 * polevl( t, ( double * ) sn, 5)/p1evl( t, ( double * ) sd, 6 );
    cc = x * polevl( t, ( double * ) cn, 5)/polevl(t, ( double * ) cd, 6 );
    goto done;
    }
if( x > 36974.0 )
    {
...
/* Auxiliary functions for large argument  */
    ...
    u = 1.0/(t * t);
    t = 1.0/t;
    f = 1.0 - u * polevl( u, ( double * ) fn, 9)/p1evl(u, ( double * ) fd, 10);
    g = t * polevl( u, ( double * ) gn, 10)/p1evl(u, ( double * ) gd, 11);
