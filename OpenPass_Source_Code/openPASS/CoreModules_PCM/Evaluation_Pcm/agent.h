...
public:
    ...
    virtual int GetAgentTypeId() const { return agentTypeId; }
    virtual int GetAgentId() const { return id; }
    virtual int GetSpawnTime() const { return 0; } // dummy

    virtual AgentVehicleType GetVehicleType() const { return AgentVehicleType::Undefined; } // dummy
    ...
    virtual double GetDistanceCOGtoFrontAxle() const { return 0.0; } // dummy
    virtual double GetWeight() const { return 0.0; } // dummy
    virtual double GetHeightCOG() const { return 0.0; } // dummy
    virtual double GetWheelbase() const { return 0.0; } // dummy
    virtual double GetMomentInertiaRoll() const { return 0.0; } // dummy
    virtual double GetMomentInertiaPitch() const { return 0.0; } // dummy
    virtual double GetMomentInertiaYaw() const { return 0.0; } // dummy
    virtual double GetFrictionCoeff() const { return 0.0; } // dummy
    virtual double GetTrackWidth() const { return 0.0; } // dummy
    virtual double GetDistanceCOGtoLeadingEdge() const { return distanceCOGtoLeadingEdge; }
    virtual double GetAccelerationX() const { return 0.0; } // dummy
    virtual double GetAccelerationY() const { return 0.0; } // dummy
    virtual double GetYawAngle() const { return yawAngle; }

    virtual std::vector<int> GetCollisionPartners() const {return {};} //dummy

    virtual void SetPositionX(double positionX) { this->positionX = positionX; }
    virtual void SetPositionY(double positionY) { this->positionY = positionY; }
    virtual void SetWidth(double width) { this->width = width; }
    virtual void SetLength(double length) { this->length = length; }
    ...
    virtual void SetDistanceCOGtoFrontAxle(double distanceCOGtoFrontAxle) { Q_UNUSED(distanceCOGtoFrontAxle); } // dummy
    virtual void SetWeight(double weight) { Q_UNUSED(weight); } // dummy
    virtual void SetHeightCOG(double heightCOG) { Q_UNUSED(heightCOG); } // dummy
    virtual void SetWheelbase(double wheelbase) { Q_UNUSED(wheelbase); } // dummy
    virtual void SetMomentInertiaRoll(double momentInertiaRoll) { Q_UNUSED(momentInertiaRoll); } // dummy
    virtual void SetMomentInertiaPitch(double momentInertiaPitch) { Q_UNUSED(momentInertiaPitch); } // dummy
    virtual void SetMomentInertiaYaw(double momentInertiaYaw) { Q_UNUSED(momentInertiaYaw); } // dummy
    virtual void SetFrictionCoeff(double frictionCoeff) { Q_UNUSED(frictionCoeff); } // dummy
    virtual void SetTrackWidth(double trackWidth) { Q_UNUSED(trackWidth); } // dummy
    ...
    virtual void SetAccelerationX(double accelerationX) { Q_UNUSED(accelerationX); } // dummy
    virtual void SetAccelerationY(double accelerationY) { Q_UNUSED(accelerationY); } // dummy
    virtual void SetYawAngle(double yawAngle) { this->yawAngle = yawAngle; }

    virtual void RemoveAgent() {
        isValid = false;
    }
    virtual void UpdateCollision(int collisionPartnerId) {Q_UNUSED(collisionPartnerId);} //dummy
    virtual bool Unlocate() {return false;} //dummy
    virtual bool Locate() {return false;} //dummy
    virtual AgentInterface *GetAgentAdapter() const {return nullptr;} //dummy
    virtual void SetAgentAdapter(AgentInterface *agentAdapter) {Q_UNUSED(agentAdapter);} //dummy
    virtual void SetBrakeLight(bool brakeLightStatus) {Q_UNUSED(brakeLightStatus);} //dummy
    virtual bool GetBrakeLight(){return false;} //dummy
    ...
    virtual bool InitAgentParameter(int id,
                                    ...
                                    int spawnTime,
                                    const AgentSpawnItem *agentSpawnItem,
                                    const SpawnItemParameterInterface &spawnItemParameter) {Q_UNUSED(id);
    ...
    virtual bool IsAgentInWorld() {return false;} //dummy
    ...
    virtual double GetDistanceToFrontAgent(int laneId) {Q_UNUSED(laneId); return 0;} //dummy
...
private:
    ...
    double distanceCOGtoLeadingEdge = 0.0;      //!< distance center of gravity to leading edge of the agent
