...
#-----------------------------------------------------------------------------
# \file  Algorithm_CruiseControlByDistance.pro
# \brief This file contains the information for the QtCreator-project of the
#        module Algorithm_VelocityByDistance
#-----------------------------------------------------------------------------/
...
TARGET = Algorithm_CruiseControlByDistance
TEMPLATE = lib
...
DEFINES += ALGORITHM_CRUISECONTROLBYDISTANCE_LIBRARY
