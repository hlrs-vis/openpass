...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_MasterPreHook(ObservationInterface *implementation)
{
    try
    {
...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_MasterPostHook(ObservationInterface *implementation,
...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_SlavePreHook(ObservationInterface *implementation,
...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_SlavePreRunHook(ObservationInterface *implementation)
{
    try
    {
...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_SlaveUpdateHook(ObservationInterface *implementation,
                                                                     int time,
...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_SlavePostRunHook(ObservationInterface *implementation,
...
extern "C" OBSERVATION_TTCSHARED_EXPORT bool OpenPASS_SlavePostHook(ObservationInterface *implementation)
{
    try
    {
...
extern "C" OBSERVATION_TTCSHARED_EXPORT const std::string OpenPASS_SlaveResultFile(ObservationInterface *implementation)
{
    try
    {
